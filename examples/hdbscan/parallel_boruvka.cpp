    ...
    : m_points(points)
{
  ...
  while (m_numComponents > 1)
  {
    ...
    updateComponents(nextEdge, nextEdgeLen);
  }
}
...
void parallelBoruvka_t::updateMST(std::vector<int> &nextEdge)
{
...
void parallelBoruvka_t::updateComponents(std::vector<int> &nextEdge,
